...
class Expenses extends CI_Controller {
	...
	public function ajax_add_expense_type(){
		...
		foreach($expense_type as $index=>$val){
			$this->expenses_model->add_expense_type($val,$min_amount[$index],$max_amount[$index]);
		}
	}
	...
	public function ajax_update_expense_type(){
		...
		$this->expenses_model->update_expense_type($expense_type_id,$expense_type,$min_amount,$max_amount);
	}

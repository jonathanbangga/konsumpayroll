		...
		public function index() {
			...
			if($this->input->post('add')){
				...
				foreach($emp_id as $key2=>$val){
					...
					$this->form_validation->set_rules("sub_dept[{$key2}]", 'Sub Department', 'trim|xss_clean');
					...
					$this->form_validation->set_rules("last_date[{$key2}]", 'Last Date', 'trim|xss_clean');
					...
					$this->form_validation->set_rules("bank_route[{$key2}]", 'Bank Route', 'trim|xss_clean');
					$this->form_validation->set_rules("bank_account[{$key2}]", 'Bank Account', 'trim|xss_clean');
					$this->form_validation->set_rules("account_type[{$key2}]", 'Account Type', 'trim|xss_clean');

<?php
	$main_employee_menu = "content_holders/main_employee_menu";
	$sidebar_employee_menu = "content_holders/sidebar_employee_menu";
  ...
  <header id="header">
    ...
    <section class="header-panel">
      ...
      <!-- HEADER-PANEL END -->
		...
		<?php print $this->load->view($main_employee_menu)?>
    <!-- HEADER END -->
  </header>
  <section id="body">
    <!-- BODY START -->
    <aside id="side-menu" class="left">
      <!-- SIDE-MENU START -->
      <?php print $this->load->view($sidebar_employee_menu);?>
      <!-- SIDE-MENU END -->
    </aside>
    <div class="rbox left">
      <!-- RBOX START -->

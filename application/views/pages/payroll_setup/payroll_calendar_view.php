        ...
        <div class="payroll-calendar-row">
          ...
          <table style="margin-bottom:8px;">
            <tr>
              ...
              <td style="width:120px;"><select style="width:120px;" class="txtselect" name="">
                </select></td>
            </tr>
            <tr>
              <td>Indicate the date of your second monthly payroll</td>
              <td><select style="width:120px;" class="txtselect" name="">
                </select></td>
            </tr>
          </table>
          <p style="padding-bottom:8px;">State the first payroll for this group that will be run by this system
            <input class="txtfield" style="width:120px;" name="" type="text">
          </p>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td style="width:180px;"><input class="txtfield" style="width:70px;" name="" type="text">
                <input class="txtfield" style="width:70px;" name="" type="text"></td>
            </tr>
            <tr>

	...
	<div class="tbl-wrap">
		<table width="1330" border="0" cellspacing="0" cellpadding="0" class="tbl table-form">
			<tr>
				...
				<th width="121">Commission Type</th>
				<th width="91">Rate %</th>
				<th width="145">Witholding Tax Rate</th>
				<th width="145">Commission Amount</th>
			</tr>
			<?php 
			if ($q) {
			...
			<tr id="<?php echo $employee->account_id?>">
				...
				<td class="rate_per"><?php echo $employee->rate_per?></td>
				<td class="tax_rate"><?php echo $employee->tax_rate?></td>
				<td class="commission_amount"><?php echo $employee->commission_amount?></td>
			</tr>	
				<?php
				}
			}
